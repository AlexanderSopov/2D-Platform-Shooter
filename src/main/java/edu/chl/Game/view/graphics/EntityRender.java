...
public class EntityRender {
	...
	public void renderNotAnimateRight(Graphics g, Sprite[] unit, int x, int y, int width, int height){
		g.drawImage(unit[0].getBufferedImage(), x, y, width, height, null);
	}
	
	public void renderNotAnimateLeft(Graphics g, Sprite[] unit, int x, int y, int width, int height, int frameAmount){
